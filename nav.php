                        ...
                        <div class="classy-menu">
                            ...
                            <span class="classynav">
                                <ul id="nav">
                                    ...
                                    <li><a href="awak.php">ABK</a></li>
                                    <li><a href="kapal.php">Kapal</a></li>
                                    <li><a href="awakhilang.php">Nelayan Hilang</a></li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        ...
                                        <a class="dropdown-item" title="Account Setting" href="acset.php">Account Setting</a>
                                        <a class="dropdown-item" title="Log out" href="action/logout.php"><strong>Log Out</strong></a>
                                    </div>
                                </li>
                                <?php else: ?>
                                <!-- Get Tickets Button -->
                                <a href="login.php" title='Log in' class="btn confer-btn mt-3 mt-lg-0 ml-3 ml-lg-5">Login</i></a>
                                <?php endif; ?>
